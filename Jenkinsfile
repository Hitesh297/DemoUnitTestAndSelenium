    ...
    stages {
        stage('Build') { 
            steps { 
			   ...
			   & 'C:\\Program Files (x86)\\Microsoft Visual Studio\\2017\\Community\\Common7\\IDE\\MSTest.exe' /resultsfile:"Results.trx" /testcontainer:"$env:WORKSPACE\\UnitTestProject1\\bin\\Release\\UnitTestProject1.dll"
